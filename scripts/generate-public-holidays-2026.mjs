...
const baseHolidays = [
  ["new-year", "Neujahr", "New Year's Day", "2026-01-01"],
  ["good-friday", "Karfreitag", "Good Friday", "2026-04-03"],
  ["easter-monday", "Ostermontag", "Easter Monday", "2026-04-06"],
  ["labour-day", "Tag der Arbeit", "Labour Day", "2026-05-01"],
  ["ascension", "Christi Himmelfahrt", "Ascension Day", "2026-05-14"],
  ["pentecost-monday", "Pfingstmontag", "Whit Monday", "2026-05-25"],
  ["german-unity", "Tag der Deutschen Einheit", "German Unity Day", "2026-10-03"],
  ["christmas-day", "1. Weihnachtsfeiertag", "Christmas Day", "2026-12-25"],
  ["second-christmas-day", "2. Weihnachtsfeiertag", "Second Day of Christmas", "2026-12-26"],
];
...
function makeHoliday(code, slug, nameDe, nameEn, date, options = {}) {
  return {
    id: `${code.toLowerCase()}-public-2026-${slug}`,
...
for (const [code, name, fileStem] of states) {
  ...
  const dataset = {
    datasetName: `schulferienklar_public_holidays_${fileStem}_2026`,
    version: "0.1",
    createdAt,
    bundeslandCode: code,
    bundeslandName: name,
    ...
    sources: [
      {
        ...
        sourceUrl: "https://www.feiertage-deutschland.de/2026/",
        secondarySourceUrl: "https://www.dgb.de/service/ratgeber/feiertage/",
        trustLevel: "reference",
        lastCheckedAt: createdAt,
        notes:
          "Dates generated from nationwide German public holidays and Bundesland-specific statutory holiday mappings for 2026. Regional/local exceptions are marked separately.",
      },
    ],
    holidays,
  };

  const fileName = `${fileStem}_2026.json`;
